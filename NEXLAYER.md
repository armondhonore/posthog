...
**Live:** [https://relaxed-weasel-posthog.cloud.nexlayer.ai](https://relaxed-weasel-posthog.cloud.nexlayer.ai)  
...
**posthog** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/posthog/posthog:latest
    path: /
    servicePorts:
    - 8000
    vars:
      DATABASE_URL: "postgresql://posthog:${POSTGRES_PASSWORD}@postgres.pod:5432/posthog"
      REDIS_URL: "redis://redis.pod:6379"
      SECRET_KEY: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"
      SITE_URL: "https://relaxed-weasel-posthog.cloud.nexlayer.ai"
